            ...
            <div class="glass-card rounded-2xl p-8 hover:shadow-2xl transition-all">
                ...
                <form method="POST" action="/students/store" class="space-y-6">
                    ...
                    <div class="flex gap-4 pt-6">
                        ...
                        <a href="/students" class="px-8 rounded-xl border border-white/30 hover-scale transition-all glass-card inline-flex items-center justify-center text-gray-100 hover:bg-white/10">
                            Cancel
                        </a>
                    </div>
                </form>
